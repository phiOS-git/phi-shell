...
// on click). A click opens the shared bar popout, which owns the network
// list (Widgets.WifiNetworkList), the live speed graph/ping stats, and the
// "Manage networks…" nmtui deep-link.
//
