...
// Widgets/Separator is already exactly this primitive (a hairline
// Rectangle driven by design tokens) — this module is a plain wrapper
// giving it bar-module shape (a `required screen`, so Bar.qml's uniform
...
// with no explicit size set. Nothing to do here; implicitHeight is enough.
Widgets.Separator {
    id: root
